...
This could be done by looking at the variance of the model. The plot (figure \ref{fig:{graphs/other}}) represents the confidence with which two instances are classified, the x axis being the classes
...
categorized as \codi{foreign\_language} and were easily identified. We can see in Figure \ref{fig:{graphs/lid1}} how almost 5000 foreign language web pages were wrongly classified and also which
categories where suffering for its noise.
