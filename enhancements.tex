...
\grafic{graphs/confusion1.tex}{Categorization confusions before split}
...
After splitting the entertainment category into subcategories and adding some categories to represent the "Other" category, Figure \ref{fig:{graphs/confusion2.tex}} shows which is the most common second option 
in every of the categories that are categorized and how far it is from being the first option.

\grafic{graphs/confusion2.tex}{Categorization confusions after split}
