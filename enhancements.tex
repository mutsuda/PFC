...
categorized as \codi{foreign\_language} and were easily identified. We can see in Figure \ref{fig:{graphs/lid1}} how the foreign language web pages were wrongly classified both in absolute values and percentage.
