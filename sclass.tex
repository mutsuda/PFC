...
is the machine where I'm writing most of this document, and \codi{rogue (Intel Core 2 Quad CPU Q9300 @ 2.5GHz 8GB RAM)} is a more powerful machine used for testing purposes. The x axis represents the 
different mapper and reducer combinations I tested while the y axis represents the number of categorized pages per second.
