...
There are several approaches in order to represent the \codi{Other} category, one of them could be taking the accuracy of a classification into account, and using a threshold to decide wether
